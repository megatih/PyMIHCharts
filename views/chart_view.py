...
class CandlestickChart(QWidget):
    ...
    def _get_margins(self) -> Tuple[int, int, int, int]:
        """Calculates dynamic margins using cached font metrics."""
    ...
    def _update_margins(self):
        """Updates internal padding attributes."""
    ...
    def _draw_legend(self, painter: QPainter):
        ...
        legend = [(self.color_setup_buy, "Buy Setup"), (self.color_setup_sell, "Sell Setup"), (self.color_perfected, "Perfected"), (self.color_cd_buy, "Buy Countdown"), (self.color_cd_sell, "Sell Countdown")]
        painter.setFont(self.font_labels)
